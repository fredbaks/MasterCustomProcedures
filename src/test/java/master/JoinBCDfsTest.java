        ...
        try (Session session = driver.session()) {
            ...
            for (int k = 1; k < 7; k++) {
                ...
                Record r = session.run(
                        "CALL master.joinbcdfs($graphName, $params) YIELD source, pathCount, nodeTimestamps, startTime, endTime RETURN source, pathCount, nodeTimestamps, startTime, endTime",
