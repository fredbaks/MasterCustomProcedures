...
public class IdxDfsProc extends master.Procedure {

        @Procedure(name = "master.idxdfs", mode = READ)
        public Stream<PathEnumerationResult> stream(
                ...
                PathEnumerationAlgorithmResult results = dfsEnum.computePathEnum(false, true);
                ...
                try {
                        new PathEnumerationResultWriter(pathEnumResult, "IDXDFS", graphNameString, k, source,
                                        target);
                } catch (IOException e) {
                        e.printStackTrace();
                }
