...
public class CDfsProc extends master.Procedure {
    ...
    public Stream<CDfsResult> stream(
        ...
        return Stream.of(new CDfsResult(source, target, results, graph, pathFactoryFacade));
    ...
    public static class CDfsResult {
        ...
        public CDfsResult(Long source, Long target, ArrayList<HugeLongArray> arrayListResults, Graph graph,
