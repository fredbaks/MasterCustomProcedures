...
public final class Yens extends Algorithm<PathFindingResult> {
     ...
     */
    // @Procedure(name = "example.yens")
    // @Description("Yens algorithm for k shortest paths")
    public static Yens sourceTarget(
        @Name("graph") Graph graph,
        @Name("parameters") YensParameters parameters,
        @Name("progresstracker") ProgressTracker progressTracker,
        @Name("terminationFlag") TerminationFlag terminationFlag
    ) {
